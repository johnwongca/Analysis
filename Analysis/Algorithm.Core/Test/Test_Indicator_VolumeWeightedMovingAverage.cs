...
{
    public class TestIndicator_VolumeWeightedMovingAverage : Indicator
    {
        VolumeWeightedMovingAverage average;

        public TestIndicator_VolumeWeightedMovingAverage(int size = DefaultDataWindowSize)
            : base(size)
        {
            SymbolID = 170976;
            ...
            average = VolumeWeightedMovingAverage(3);
        }
    ...
    {
        public static void Test_Indicator_VolumeWeightedMovingAverage()
        {
            TestIndicator_VolumeWeightedMovingAverage indicator = new TestIndicator_VolumeWeightedMovingAverage(5);
