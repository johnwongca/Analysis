...
{
    public class TestIndicator_SimpleMovingAverage : Indicator
    {
        SimpleMovingAverage average;

        public TestIndicator_SimpleMovingAverage(int size = DefaultDataWindowSize)
            : base(size)
        {
            SymbolID = 170976;
    ...
    {
        public static void Test_Indicator_SimpleMovingAverage()
        {
            TestIndicator_SimpleMovingAverage indicator = new TestIndicator_SimpleMovingAverage(5);
