...
{
    public class TestIndicator_MeanDeviation : Indicator
    {
        MeanDeviation w;

        public TestIndicator_MeanDeviation(int size = DefaultDataWindowSize)
            : base(size)
        {
            SymbolID = 170976;
    ...
    {
        public static void Test_Indicator_MeanDeviation()
        {
            TestIndicator_MeanDeviation indicator = new TestIndicator_MeanDeviation(5);
