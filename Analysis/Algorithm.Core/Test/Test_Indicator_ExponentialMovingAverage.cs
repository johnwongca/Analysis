...
{
    public class TestIndicator_ExponentialMovingAverage : Indicator
    {
        ExponentialMovingAverage average;

        public TestIndicator_ExponentialMovingAverage(int size = DefaultDataWindowSize)
            : base(size)
        {
            SymbolID = 170976;
            ...
            average = ExponentialMovingAverage(3);
            average.IsWildersSmoothing = true;
        }
    ...
    {
        public static void Test_Indicator_ExponentialMovingAverage()
        {
            TestIndicator_ExponentialMovingAverage indicator = new TestIndicator_ExponentialMovingAverage(5);
